...
if(isset($login))
{
  ...
  { 
    $pql=mysqli_query($con,"select * from blockedusers where email='$eid'");
    if(mysqli_num_rows($pql)>0)
	{
		$error= "<h4 style='color:red'>You are blocked from visiting this website</h4>";
	}
     else{
      ...
      <div class="col-sm-4"></div>
        <div class="col-sm-4 text-center"style="box-shadow:2px 2px 2px;background-color:#f4ac41;"><br>
          ...
          <div class="form-group forget">
                <a href="Forget.php">Forget Account</a>&nbsp; <b>|</b>&nbsp; 
